        ...
        ActivityCompat.OnRequestPermissionsResultCallback, VehicleChangeListener, BusStopListener
{
    ...
    public static String KEY_ROUTE_ID = "stopID";
    public static String KEY_ROUTE_NAME = "stopName";
    /**
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        ListView listView = (ListView) findViewById(R.id.scheduleList1);
        listView.setAdapter(scheduleListAdapter);

        Spinner spinner = (Spinner) findViewById(R.id.spinner_fix1);
        ...
        if (null != routeID)
        {
            ...
            DatabaseReference busStopRef = mDatabase.child("stops/" + routeID);
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        mMap = googleMap;
        enableMyLocation();
        LatLng mapCenter = new LatLng(-8.5869073,116.0921869);
...
//                scheduledStopsList.add(busStop.getStopName());
//                scheduledStopsAdapter.notifyDataSetChanged();
//                List<StopSchedule> stopSchedules = scheduleMap.get(routeID);
